...
var app = (function () {
    ...
    */
    ...
    function create_else_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$i, 123, 2, 3209);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$i, 119, 2, 3118);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$h(ctx) {
    	...
    	let if_block_anchor;
    	let current;
    	const if_block_creators = [create_if_block$4, create_if_block_1$4, create_if_block_2$3, create_else_block$4];
    	const if_blocks = [];
    ...
    function create_fragment$f(ctx) {
    	...
    	let if_block_anchor;
    	let current;
    	const if_block_creators = [create_if_block$3, create_if_block_1$3, create_if_block_2$2, create_else_block$3];
    	const if_blocks = [];
    ...
    const file$7 = "node_modules/sveltestrap/src/NavbarBrand.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			set_attributes(a, a_data);
    			add_location(a, file$7, 10, 0, 192);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const fileName = writable('untitled.md');

    /* src/components/EditorMenu.svelte generated by Svelte v3.48.0 */

    const { console: console_1 } = globals;
    const file$6 = "src/components/EditorMenu.svelte";

    // (47:4) <NavbarBrand href="/">
    function create_default_slot_11(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			if (!src_url_equal(img.src, img_src_value = "./sveltelogo.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "svelte-logo");
    			attr_dev(img, "class", "svelte-qvldwo");
    			add_location(img, file$6, 47, 6, 1070);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_10(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(51:6) <DropdownToggle nav caret>",
    		ctx
    	});
    ...
    function create_default_slot_9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file$6, 53, 10, 1284);
    			attr_dev(input, "type", "file");
    			attr_dev(input, "class", "file-input svelte-qvldwo");
    			attr_dev(input, "id", "file-input");
    			add_location(input, file$6, 54, 10, 1336);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, label, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "change", /*handleFileSelected*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    // (62:8) <DropdownItem on:click={handleSaveFile($fileName)} >
    function create_default_slot_8(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(62:8) <DropdownItem on:click={handleSaveFile($fileName)} >",
    		ctx
    	});
    ...
    function create_default_slot_6$2(ctx) {
    	...
    	dropdownitem1.$on("click", function () {
    		if (is_function(/*handleSaveFile*/ ctx[2](/*$fileName*/ ctx[0]))) /*handleSaveFile*/ ctx[2](/*$fileName*/ ctx[0]).apply(this, arguments);
    	});
    ...
    // (50:4) <Dropdown dark nav inNavbar>
    function create_default_slot_5$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(50:4) <Dropdown dark nav inNavbar>",
    		ctx
    	});
    ...
    // (70:6) <NavLink on:click={() => push(linkHelp)}>
    function create_default_slot_4$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(70:6) <NavLink on:click={() => push(linkHelp)}>",
    		ctx
    	});
    ...
    // (73:6) <NavLink on:click={() => push(linkAbout)}>
    function create_default_slot_2$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(73:6) <NavLink on:click={() => push(linkAbout)}>",
    		ctx
    	});
    ...
    function create_default_slot$3(ctx) {
    	...
    	navitem2 = new NavItem({ props: { divider: true }, $$inline: true });
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "nav-bar");
    			add_location(div, file$6, 44, 0, 1002);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const linkHelp$1 = "/help";
    const linkAbout$1 = "/about";

    function instance$6($$self, $$props, $$invalidate) {
    	let $textStore;
    	let $fileName;
    	validate_store(textStore, 'textStore');
    	component_subscribe($$self, textStore, $$value => $$invalidate(6, $textStore = $$value));
    	...
    	const handleFileSelected = e => {
    		...
    		set_store_value(fileName, $fileName = file.name, $fileName);
    		...
    		reader.onload = e => {
    			...
    			set_store_value(textStore, $textStore = content, $textStore);
    		};
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<EditorMenu> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => push(linkHelp$1);
    	const click_handler_1 = () => push(linkAbout$1);
    	...
    	return [$fileName, handleFileSelected, handleSaveFile, click_handler, click_handler_1];
    }
    ...
    /* src/components/DdSpeak.svelte generated by Svelte v3.48.0 */

    const file$5 = "src/components/DdSpeak.svelte";
    ...
    function create_default_slot_6$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(43:2) <DropdownToggle nav caret>",
    		ctx
    	});
    ...
    // (45:4) <DropdownItem on:click={play} color="dark">
    function create_default_slot_5$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(45:4) <DropdownItem on:click={play} color=\\\"dark\\\">",
    		ctx
    	});
    ...
    function create_default_slot_4$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(47:4) <DropdownItem header>",
    		ctx
    	});
    ...
    // (48:4) <Label class="label" for="voices">
    function create_default_slot_3$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(48:4) <Label class=\\\"label\\\" for=\\\"voices\\\">",
    		ctx
    	});
    ...
    // (50:6) {#each voices as voice}
    function create_each_block(ctx) {
    	let option;
    	let t_value = printVoice(/*voice*/ ctx[8]) + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = option_value_value = /*voice*/ ctx[8];
    			option.value = option.__value;
    			attr_dev(option, "class", "svelte-1yvhe5t");
    			add_location(option, file$5, 50, 8, 1252);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*voices*/ 1 && t_value !== (t_value = printVoice(/*voice*/ ctx[8]) + "")) set_data_dev(t, t_value);

    			if (dirty & /*voices*/ 1 && option_value_value !== (option_value_value = /*voice*/ ctx[8])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:6) {#each voices as voice}",
    		ctx
    	});
    ...
    // (49:4) <Input class="input" bind:value={selectedVoice} type="select" id="voices">
    function create_default_slot_2$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(49:4) <Input class=\\\"input\\\" bind:value={selectedVoice} type=\\\"select\\\" id=\\\"voices\\\">",
    		ctx
    	});
    ...
    function create_default_slot_1$2(ctx) {
    	...
    	dropdownitem0.$on("click", /*play*/ ctx[2]);
    	...
    	if (/*selectedVoice*/ ctx[1] !== void 0) {
    		input_props.value = /*selectedVoice*/ ctx[1];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, voices*/ 2049) {
    				input_changes.$$scope = { dirty, ctx };
    			}

    			if (!updating_value && dirty & /*selectedVoice*/ 2) {
    				updating_value = true;
    				input_changes.value = /*selectedVoice*/ ctx[1];
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    // (42:0) <Dropdown dark nav inNavbar>
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, selectedVoice, voices*/ 2051) {
    				dropdownmenu_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(42:0) <Dropdown dark nav inNavbar>",
    		ctx
    	});
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	let $textStore;
    	validate_store(textStore, 'textStore');
    	component_subscribe($$self, textStore, $$value => $$invalidate(4, $textStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('DdSpeak', slots, []);
    	let { voices = [] } = $$props;
    	let pitch = 1;
    	let rate = 1;
    	let volume = 1;
    	let { selectedVoice } = $$props;

    	onMount(() => {
    		speechSynthesis.onvoiceschanged = () => {
    			$$invalidate(0, voices = speechSynthesis.getVoices());
    			$$invalidate(1, selectedVoice = voices[0]);
    		};
    	});
    	...
    	const writable_props = ['voices', 'selectedVoice'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<DdSpeak> was created with unknown prop '${key}'`);
    	});

    	function input_value_binding(value) {
    		selectedVoice = value;
    		$$invalidate(1, selectedVoice);
    	}

    	$$self.$$set = $$props => {
    		if ('voices' in $$props) $$invalidate(0, voices = $$props.voices);
    		if ('selectedVoice' in $$props) $$invalidate(1, selectedVoice = $$props.selectedVoice);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ('voices' in $$props) $$invalidate(0, voices = $$props.voices);
    		if ('pitch' in $$props) pitch = $$props.pitch;
    		if ('rate' in $$props) rate = $$props.rate;
    	...
    	return [voices, selectedVoice, play, input_value_binding];
    }

    class DdSpeak extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { voices: 0, selectedVoice: 1 });
    		...
    		if (/*selectedVoice*/ ctx[1] === undefined && !('selectedVoice' in props)) {
    			console.warn("<DdSpeak> was created without expected prop 'selectedVoice'");
    		}
    	}

    	get voices() {
    		throw new Error("<DdSpeak>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set voices(value) {
    		throw new Error("<DdSpeak>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src/components/Editor.svelte generated by Svelte v3.48.0 */
    ...
    // (28:6) <NavLink on:click={handleTogglePreview} href="#">
    function create_default_slot_3$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(28:6) <NavLink on:click={handleTogglePreview} href=\\\"#\\\">",
    		ctx
    	});
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	navlink.$on("click", /*handleTogglePreview*/ ctx[2]);
    ...
    // (24:6) <NavLink on:click={handleTogglePreview} href="#">
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(24:6) <NavLink on:click={handleTogglePreview} href=\\\"#\\\">",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			textarea = element("textarea");
    			attr_dev(textarea, "class", "md-input svelte-1ss658v");
    			add_location(textarea, file$4, 39, 4, 867);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, textarea, anchor);
    			set_input_value(textarea, /*$textStore*/ ctx[1]);
    ...
    function create_if_block(ctx) {
    	let t;
    	let div;
    	let raw_value = marked(/*$textStore*/ ctx[1]) + "";

    	const block = {
    		c: function create() {
    			t = text("Preview\n    ");
    			div = element("div");
    			attr_dev(div, "class", "prev svelte-1ss658v");
    			add_location(div, file$4, 35, 4, 790);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$textStore*/ 2 && raw_value !== (raw_value = marked(/*$textStore*/ ctx[1]) + "")) div.innerHTML = raw_value;		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    			if (detaching) detach_dev(div);
    		}
    ...
    function create_fragment$4(ctx) {
    	...
    	ddspeak = new DdSpeak({
    			props: { $textStore: /*$textStore*/ ctx[1] },
    			$$inline: true
    		});
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*preview*/ ctx[0]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			create_component(ddspeak.$$.fragment);
    			t1 = space();
    			if_block0.c();
    			t2 = space();
    			section = element("section");
    			if_block1.c();
    			attr_dev(div, "class", "div-menu svelte-1ss658v");
    			add_location(div, file$4, 18, 0, 436);
    			attr_dev(section, "class", "svelte-1ss658v");
    			add_location(section, file$4, 32, 0, 748);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(editormenu, div, null);
    			append_dev(div, t0);
    			mount_component(ddspeak, div, null);
    			append_dev(div, t1);
    		...
    		p: function update(ctx, [dirty]) {
    			const ddspeak_changes = {};
    			if (dirty & /*$textStore*/ 2) ddspeak_changes.$textStore = /*$textStore*/ ctx[1];
    			ddspeak.$set(ddspeak_changes);
    			let previous_block_index = current_block_type_index;
    			current_block_type_index = select_block_type(ctx);
    		...
    		i: function intro(local) {
    			...
    			transition_in(ddspeak.$$.fragment, local);
    			transition_in(if_block0);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(editormenu.$$.fragment, local);
    			transition_out(ddspeak.$$.fragment, local);
    			transition_out(if_block0);
    			current = false;
    		},
    		d: function destroy(detaching) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('visibleHelp' in $$props) visibleHelp = $$props.visibleHelp;
    	};
    	...
    	return [preview, $textStore, handleTogglePreview, showHelp, textarea_input_handler];
    }

    class Editor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { showHelp: 3 });
    ...
    /* src/components/HelpMenu.svelte generated by Svelte v3.48.0 */
    const file$3 = "src/components/HelpMenu.svelte";

    // (19:4) <NavbarBrand href="/">
    function create_default_slot_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = "./sveltelogo.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "svelte-logo");
    			attr_dev(img, "class", "svelte-u0jxqc");
    			add_location(img, file$3, 19, 6, 326);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    // (23:6) <NavLink on:click={() => push(linkEditor)}>
    function create_default_slot_6(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(23:6) <NavLink on:click={() => push(linkEditor)}>",
    		ctx
    	});
    ...
    function create_default_slot_5(ctx) {
    	...
    	navlink.$on("click", /*click_handler*/ ctx[0]);
    ...
    // (26:6) <NavLink on:click={() => push(linkHelp)}>
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:6) <NavLink on:click={() => push(linkHelp)}>",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	navlink.$on("click", /*click_handler_1*/ ctx[1]);
    ...
    // (29:6) <NavLink on:click={() => push(linkAbout)}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(29:6) <NavLink on:click={() => push(linkAbout)}>",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	navlink.$on("click", /*click_handler_2*/ ctx[2]);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(nav.$$.fragment);
    			attr_dev(div, "class", "nav-bar svelte-u0jxqc");
    			add_location(div, file$3, 15, 0, 236);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<HelpMenu> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => push(linkEditor);
    	const click_handler_1 = () => push(linkHelp);
    	const click_handler_2 = () => push(linkAbout);
    ...
    /* src/components/Help.svelte generated by Svelte v3.48.0 */
    const file$2 = "src/components/Help.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			section = element("section");
    			h1 = element("h1");
    			h1.textContent = "Markdown Reference:";
    			t2 = space();
    			hr0 = element("hr");
    			t3 = space();
    			div = element("div");
    			a = element("a");
    			a.textContent = "Marcdownguide.org";
    			t5 = space();
    			hr1 = element("hr");
    			t6 = space();
    			br0 = element("br");
    			t7 = space();
    			h20 = element("h2");
    			h20.textContent = "Headings:";
    			t9 = space();
    			p0 = element("p");
    			p0.textContent = "# H1, ## H2, ### H3 one number-sign for every heading-level, one space\n    between number-sign and your heading-text.";
    			t11 = space();
    			h21 = element("h2");
    			h21.textContent = "Bold text:";
    			t13 = space();
    			p1 = element("p");
    			p1.textContent = "**some bold text inside two asterisk-sign, no space between symbo and your\n    text.**";
    			t15 = space();
    			h22 = element("h2");
    			h22.textContent = "Blockquote:";
    			t17 = space();
    			p2 = element("p");
    			p2.textContent = ">your quote after one greater-than-sign at the beginning, no space\n    between symbol and your text.";
    			t19 = space();
    			h23 = element("h2");
    			h23.textContent = "Unordered list:";
    			t21 = space();
    			p3 = element("p");
    			p3.textContent = "-item";
    			t23 = space();
    			...
    			t27 = space();
    			h24 = element("h2");
    			h24.textContent = "Ordered list:";
    			t29 = space();
    			p6 = element("p");
    			p6.textContent = "1. item one";
    			t31 = space();
    			p7 = element("p");
    			p7.textContent = "2. item one";
    			t33 = space();
    			p8 = element("p");
    			p8.textContent = "3. item one";
    			t35 = space();
    			h25 = element("h2");
    			h25.textContent = "Code:";
    			t37 = space();
    			p9 = element("p");
    			p9.textContent = "`some code, inside one backtick at the beginning and on end, you must press\n    spacebar after setting the backtick!`";
    			t39 = space();
    			h26 = element("h2");
    			h26.textContent = "CodeBlock:";
    			t41 = space();
    			p10 = element("p");
    			t42 = text("```lang\n    ");
    			br1 = element("br");
    			t43 = text("\n    some code inside three backticks, followd by the name of programming-language:\n    lang e.g. js, ruby or java\n    ");
    			br2 = element("br");
    			t44 = text("\n    ```");
    			t45 = space();
    			h27 = element("h2");
    			h27.textContent = "Link:";
    			t47 = space();
    			p11 = element("p");
    			p11.textContent = "[title](https://www.example.com)";
    			t49 = space();
    			h28 = element("h2");
    			h28.textContent = "Image:";
    			t51 = space();
    			p12 = element("p");
    			p12.textContent = "![alt text](image.jpg)";
    			attr_dev(h1, "class", "svelte-161f5oa");
    			add_location(h1, file$2, 7, 2, 90);
    			add_location(hr0, file$2, 8, 2, 121);
    			attr_dev(a, "href", "https://www.markdownguide.org/basic-syntax/");
    			attr_dev(a, "class", "svelte-161f5oa");
    			add_location(a, file$2, 10, 4, 153);
    			attr_dev(div, "class", "link svelte-161f5oa");
    			add_location(div, file$2, 9, 2, 130);
    			add_location(hr1, file$2, 12, 2, 240);
    			add_location(br0, file$2, 13, 2, 249);
    			add_location(h20, file$2, 14, 2, 258);
    			add_location(p0, file$2, 15, 2, 279);
    			add_location(h21, file$2, 19, 2, 414);
    			add_location(p1, file$2, 20, 2, 436);
    			add_location(h22, file$2, 24, 2, 540);
    			add_location(p2, file$2, 25, 2, 563);
    			add_location(h23, file$2, 29, 2, 684);
    			add_location(p3, file$2, 30, 2, 711);
    			add_location(p4, file$2, 31, 2, 726);
    			add_location(p5, file$2, 32, 2, 741);
    			add_location(h24, file$2, 33, 2, 756);
    			add_location(p6, file$2, 34, 2, 781);
    			add_location(p7, file$2, 35, 2, 802);
    			add_location(p8, file$2, 36, 2, 823);
    			add_location(h25, file$2, 37, 2, 844);
    			add_location(p9, file$2, 38, 2, 861);
    			add_location(h26, file$2, 42, 2, 996);
    			add_location(br1, file$2, 45, 4, 1038);
    			add_location(br2, file$2, 48, 4, 1163);
    			add_location(p10, file$2, 43, 2, 1018);
    			add_location(h27, file$2, 51, 2, 1187);
    			add_location(p11, file$2, 52, 2, 1204);
    			add_location(h28, file$2, 53, 2, 1246);
    			add_location(p12, file$2, 54, 2, 1264);
    			attr_dev(section, "class", "svelte-161f5oa");
    			add_location(section, file$2, 6, 0, 78);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			mount_component(helpmenu, target, anchor);
    			insert_dev(target, t0, anchor);
    			insert_dev(target, section, anchor);
    		...
    		d: function destroy(detaching) {
    			destroy_component(helpmenu, detaching);
    			if (detaching) detach_dev(t0);
    			if (detaching) detach_dev(section);
    		}
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			div0 = element("div");
    			t4 = text("The Editor is a part of my project \"Speaking Notes\", which will show, how to\n    create an Application for visual impared users. You can find nearly the same\n    App, written with\n    ");
    			ul = element("ul");
    			t5 = space();
    			li0 = element("li");
    			t6 = text("JavaScript only, ");
    			a0 = element("a");
    			a0.textContent = "GitHub: Speaking-Notes 1";
    			t8 = space();
    			li1 = element("li");
    			t9 = text("React (plain text), ");
    			a1 = element("a");
    			a1.textContent = "GitHub: Speaking-Notes-React 2";
    			t11 = space();
    			li2 = element("li");
    			t12 = text("React and Electron, ");
    			a2 = element("a");
    			a2.textContent = "GitHub: speaking-notes-erb 3";
    			t14 = space();
    			li3 = element("li");
    			t15 = text("React (Markdown), ");
    			a3 = element("a");
    			a3.textContent = "GitHub: Speaking-Notes-MD 4";
    			t17 = space();
    			br0 = element("br");
    			...
    			t19 = text("\n    Homepage:");
    			a4 = element("a");
    			a4.textContent = "henrietteBaum.github.io";
    			t21 = space();
    			br1 = element("br");
    			t22 = text("\n    Copyright © 2022 Henriette Baum");
    			attr_dev(h1, "class", "svelte-1gckb2x");
    			add_location(h1, file$1, 7, 2, 102);
    			add_location(hr0, file$1, 8, 2, 119);
    			add_location(ul, file$1, 13, 4, 338);
    			attr_dev(a0, "href", "https://github.com/henrietteBaum/Speaking-Notes");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$1, 15, 23, 377);
    			add_location(li0, file$1, 14, 4, 349);
    			attr_dev(a1, "href", "https://github.com/henrietteBaum/Speaking-Notes-React");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$1, 21, 26, 548);
    			add_location(li1, file$1, 20, 4, 517);
    			attr_dev(a2, "href", "https://github.com/henrietteBaum/speaking-notes-erb");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file$1, 27, 26, 731);
    			add_location(li2, file$1, 26, 4, 700);
    			attr_dev(a3, "href", "https://github.com/henrietteBaum/Speaking-Notes-MD");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file$1, 33, 24, 908);
    			add_location(li3, file$1, 32, 4, 879);
    			add_location(br0, file$1, 38, 4, 1054);
    			add_location(hr1, file$1, 41, 4, 1097);
    			attr_dev(a4, "href", "https://github.com/henrietteBaum/henrietteBaum.github.io");
    			attr_dev(a4, "target", "_blank");
    			add_location(a4, file$1, 42, 13, 1117);
    			add_location(br1, file$1, 46, 4, 1249);
    			attr_dev(div0, "class", "content svelte-1gckb2x");
    			add_location(div0, file$1, 9, 2, 128);
    			attr_dev(div1, "class", "about svelte-1gckb2x");
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(helpmenu, div1, null);
    			append_dev(div1, t0);
    			append_dev(div1, h1);
    			append_dev(div1, t2);
    			append_dev(div1, hr0);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1icumys");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Editor, Help, About, routes });
